"""
Django settings for MatchJob project.
...
SECRET_KEY = 'django-insecure-3$59aeffoijj0z^d7aa!@_f@=9l#%l9d0@6#yxwy9n(hjy!aaf'
...
INSTALLED_APPS = [
    ...
    'gestionOfertas',  # Aplicación de gestión de ofertas
...
#indica cuual es el modelo de usuario,personalizado
